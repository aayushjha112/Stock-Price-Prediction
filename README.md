...
Models: Linear Regression, Support Vector Regression (SVR), Random Forest Regressor, Adaboost Regressor, Gradient Boost Regressor, XGBoost Regressor, LightGBM Regressor. <br>
Conducted hyperparameter tuning and calculted MAE, MSE, % MAE for each model. <br>
Also performed check on normality of residuals (QQ Plot), feature linearity, autocorrelation of residuals (ACF/PACF/Ljung-Box Test), heteroskedasticity (Breusch-Pagan Test). <br>
